(define (problem biology_exam_study)
    ...
    (:init
        ...
        (has-preference Bob chapter4)
        (has-preference Charlie chapter5)
        (has-preference Dana chapter1)
        (has-preference Dana chapter3)
        (has-preference Evan chapter2)
